...
import se.skltp.messagebox.deleteanswers.v1.rivtabp20.DeleteAnswersResponderInterface;
import se.skltp.messagebox.deleteanswers.v1.rivtabp20.DeleteAnswersResponderService;
import se.skltp.messagebox.deleteanswersresponder.v1.DeleteAnswersType;
import se.skltp.messagebox.findallanswers.v1.rivtabp20.FindAllAnswersResponderInterface;
import se.skltp.messagebox.findallanswers.v1.rivtabp20.FindAllAnswersResponderService;
import se.skltp.messagebox.findallanswersresponder.v1.AnswerType;
import se.skltp.messagebox.findallanswersresponder.v1.FindAllAnswersResponseType;
import se.skltp.messagebox.findallanswersresponder.v1.FindAllAnswersType;
import se.skltp.messagebox.qa.v1.Amnetyp;
import se.skltp.messagebox.qa.v1.InnehallType;
import se.skltp.messagebox.receivemedicalcertificateanswer.v1.rivtabp20.ReceiveMedicalCertificateAnswerResponderInterface;
import se.skltp.messagebox.receivemedicalcertificateanswer.v1.rivtabp20.ReceiveMedicalCertificateAnswerResponderService;
import se.skltp.messagebox.receivemedicalcertificateanswerresponder.v1.AnswerFromFkType;
import se.skltp.messagebox.receivemedicalcertificateanswerresponder.v1.ReceiveMedicalCertificateAnswerResponseType;
import se.skltp.messagebox.receivemedicalcertificateanswerresponder.v1.ReceiveMedicalCertificateAnswerType;
