 ...
 * {@link se.skltp.mb.types.entity.MessageBody}.
 * <p/>
...
public interface MessageMetaRepository extends Repository<MessageMeta, Long> {
     ...
     *
     * @return created message, with arrival time set to TimeService.now() and status {@link se.skltp.mb.types.entity.MessageStatus#RECEIVED}
     */
