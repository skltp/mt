...
import se.inera.ifv.casebox.core.service.OverviewService;
...
public class OverviewServiceImpl implements OverviewService {
    ...
    public List<CareUnitInfo> getCareUnitInfos(int maxNumber) {
        ...
        b.addAll(entityManager.createQuery(
                "select " + 
                "new se.inera.ifv.casebox.core.service.impl.CareUnitInfoQuestionInternal(q.careUnit, q.status, count(q)) " +
        	"from Question q group by q.careUnit, q.status")
        	.getResultList());
        b.addAll(entityManager.createQuery(
                "select " + 
                "new se.inera.ifv.casebox.core.service.impl.CareUnitInfoAnswerInternal(a.careUnit, a.status, count(a)) " +
